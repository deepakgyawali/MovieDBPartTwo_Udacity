...
public class Constants {
    ...
    public static final String ACTION_MOVIES_REQUEST =
            "com.deepakgyawali.moviedbparttwo.ACTION_MOVIES_REQUEST";
    public static final String ACTION_EXTRA_INFO_REQUEST =
            "com.deepakgyawali.moviedbparttwo.ACTION_EXTRA_INFO_REQUEST";
    public static final String ACTION_MOVIES_RESULT =
            "com.deepakgyawali.moviedbparttwo.ACTION_MOVIES_RESULT";
    public static final String ACTION_EXTRA_INFO_RESULT =
            "com.deepakgyawali.moviedbparttwo.ACTION_EXTRA_INFO_RESULT";
